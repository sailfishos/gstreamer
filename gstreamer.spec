...
Patch1:     0001-info-make-adding-removing-of-gst_debug_log_default-w.patch
Patch2:     0002-valve-Only-set-discont-on-the-first-buffer-after-drops.patch
Patch3:     donot-set-first-buffer-timestamp-to-zero.patch
...
%patch0 -p1
# 0001-info-make-adding-removing-of-gst_debug_log_default-w.patch
%patch1 -p1
# 0002-valve-Only-set-discont-on-the-first-buffer-after-drops.patch
%patch2 -p1
# donot-set-first-buffer-timestamp-to-zero.patch
%patch3 -p1
# >> setup
# << setup
